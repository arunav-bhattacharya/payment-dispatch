...
CREATE TABLE EXEC_RATE_CONFIG (
    ...
    max_stale_recovery_per_cycle    NUMBER(5)       DEFAULT 50 NOT NULL,
...
-- Stale claim recovery query: finds CLAIMED rows older than threshold
...
INSERT INTO EXEC_RATE_CONFIG (
    ...
    stale_claim_threshold_mins, max_stale_recovery_per_cycle,
